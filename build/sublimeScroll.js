...
(function(){
  ...
  SublimeScroll = (function(){
    ...
    prototype.onMousedown = function(event){
      ...
      this.el.wrapper.add(this.el.scrollBar.closest('body')).addClass('sublime-scroll-dragging');
    ...
    prototype.onDragEnd = function(event){
      ...
      this.el.wrapper.add(this.el.scrollBar.closest('body')).removeClass('sublime-scroll-dragging');
